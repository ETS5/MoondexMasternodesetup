...
In addition, for those who wonder what does **moondex.conf** file looks like for a typical masternode, which the setup script generates, here is an example below...
